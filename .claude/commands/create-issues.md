...
2. **Read the issue template** at:
   `projectManager/skills/project-management/references/issue-template.md`
...
7. **Validate the issue set**:
   - Run dependency check: `bash projectManager/skills/project-management/scripts/check-dependencies.sh projectManager/issues/$ARGUMENTS.feature-name/`
